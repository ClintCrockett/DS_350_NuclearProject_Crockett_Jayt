...
-   Daily returns were computed using tidyquant’s built-in financial functions.
...
geom_line(aes(y = JPM_above), color = "#044578", linewidth = 1) +  # JPM blue
geom_line(aes(y = JPM_below), color = "red", linewidth = 1) +       # JPM underperformance red

# GS lines (lighter red)

geom_line(aes(y = GS_above), color = "#6f94c1", linewidth = 1) +     # GS blue
geom_line(aes(y = GS_below), color = "#ff7f7f", linewidth = 1) +     # GS light red
